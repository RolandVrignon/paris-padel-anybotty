...
**Mise à jour du 13 septembre 2026 :** le récapitulatif peut afficher le nom du terrain dans un paragraphe `font-bold text-sm leading-tight`, sans la ligne de caractéristiques `opacity-70` de l’ancienne version. Le script reconnaît les deux présentations. Lorsque les caractéristiques sont absentes, une préférence intérieur/extérieur reste vérifiable uniquement si elle a été contrôlée dans la modale de cette même tentative et que le récapitulatif affiche exactement le terrain choisi. Cette information reste en mémoire sur la même page et est effacée à chaque nouvelle sélection ; elle ne provient jamais du descriptif général du club. Un accès direct sans caractéristiques ni preuve issue de la modale bloque une préférence stricte. Le parcours headless UCPA du 19 septembre à 7 h, 60 minutes, terrain 7 intérieur à 38 €, a atteint le récapitulatif avec les conditions décochées et sans soumission de paiement.
