...
- **4PADEL Saint-Ouen et Paris 20** : calendrier complet horaire, plus les confirmations d’une apparition déjà détectée. Leur calendrier à J+30 ne permet pas de mesurer leur autorisation réelle de réserver. Boulogne reste leur référence horaire indicative, sans tester un paiement toutes les cinq minutes.
